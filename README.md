...
> Ma secondo i log che si trovano in `/dev/shm` la memoria condivisa viene usata.
> FastDDS Monitor mostra UDPv4 in Locators per i Participants perché a quanto pare quello è usato per la **discovery** (trovare altri participant).
